...
mod tests {
    ...
    fn test_error_sanitization() {
        assert_eq!(sanitize_error_message("Failed to parse JSON"), "Invalid request format");
        assert_eq!(sanitize_error_message("User not found"), "Resource not found");
        ...
        assert_eq!(sanitize_error_message("Random error"), "Internal server error");
    }
}