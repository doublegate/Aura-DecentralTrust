...
mod tests {
    ...
    fn test_create_presentation_credential_not_found() {
        ...
        let result =
            generator.create_presentation(&holder_did, vec!["nonexistent".to_string()], None, None);
    ...
    fn test_create_presentation_invalid_holder() {
        ...
        let result = generator.create_presentation(&invalid_did, vec![], None, None);
    ...
    fn test_create_selective_presentation() {
        ...
        generator
            .vc_store
            .store_credential(credential, vec![])
            .unwrap();
    ...
    fn test_verify_presentation_wrong_key() {
        ...
        // Create presentation
        let presentation = generator
            .create_presentation(&holder_did, vec!["cred1".to_string()], None, None)
            .unwrap();
    ...
    fn test_create_empty_presentation() {
        ...
        let presentation = generator
            .create_presentation(&holder_did, vec![], None, None)
            .unwrap();
